                    ...
                    <div className="p-2.5 sm:p-4">
                      ...
                      {product.stock === "In Stock" ? (
                        ...
                        <span className={`inline-block text-[10px] sm:text-xs font-bold px-2 sm:px-3 py-1 sm:py-1.5 rounded-full mb-2 sm:mb-3 ${
                          product.stock === "Out of Stock" ? "bg-red-100 text-red-600" : product.stock === "Pre-Order" ? "bg-blue-100 text-blue-600" : "bg-amber-100 text-amber-600"
                        }`}>
                          {product.stock}
                        </span>
                      )}
                  ...
                  <div className="px-2.5 pb-2.5 sm:px-4 sm:pb-4">
                    <div className="flex items-center gap-1.5 sm:gap-2">
                      {product.stock === "In Stock" ? (
                        ...
                        <button className="flex-1 bg-blue-600 hover:bg-blue-700 text-white text-[10px] sm:text-xs font-semibold py-2 sm:py-2.5 rounded-md transition-colors">Pre-Order</button>
                      ) : (
                    ...
                    <div className="bg-white rounded-xl overflow-hidden flex group hover:shadow-md transition-all duration-300">
                      ...
                      <div className="flex-1 p-3 sm:p-5 flex flex-col justify-center">
                        ...
                        {product.stock === "In Stock" ? (
                          ...
                          <span className={`inline-block text-[10px] sm:text-xs font-bold px-2 sm:px-3 py-1 sm:py-1.5 rounded-full ${
                            product.stock === "Out of Stock" ? "bg-red-100 text-red-600" : product.stock === "Pre-Order" ? "bg-blue-100 text-blue-600" : "bg-amber-100 text-amber-600"
                          }`}>
                            {product.stock}
                          </span>
