  ...
  return (
    <div className="fixed bottom-20 md:bottom-6 right-4 min-[480px]:right-6 z-[999]">
        ...
        {open && (
          ...
          >
            ...
            <div
              ...
              style={{ background: "linear-gradient(135deg, #0078FF 0%, #004ABB 100%)" }}
            >
      ...
      <motion.button
        ...
        whileTap={{ scale: 0.95 }}
        className="relative w-14 h-14 rounded-full flex items-center justify-center shadow-[0_4px_14px_rgba(0,96,221,0.4)] transition-all border border-[rgba(255,255,255,0.1)]"
        style={{ background: "linear-gradient(180deg, #0078FF 0%, #0060DD 50%, #004ABB 100%)" }}
      >
        <span className="absolute inset-x-0 top-0 h-[45%] bg-gradient-to-b from-white/15 to-transparent rounded-t-full pointer-events-none"></span>
        {open ? (
          <X size={22} className="text-white relative" />
        ) : (
          <svg viewBox="0 0 24 24" fill="white" className="relative w-6 h-6">
            <path d="M12 2C6.36 2 2 6.13 2 11.7c0 2.91 1.2 5.42 3.15 7.2.16.15.26.36.27.58l.05 1.82c.02.56.6.93 1.11.7l2.04-.9c.17-.08.36-.1.55-.06.88.24 1.82.37 2.83.37 5.64 0 10-4.13 10-9.7S17.64 2 12 2zm6.28 7.58-3.07 4.87c-.49.78-1.54.98-2.29.43l-2.44-1.83a.75.75 0 00-.9 0l-3.3 2.5c-.44.33-1.01-.17-.72-.64l3.07-4.87c.49-.78 1.54-.98 2.29-.43l2.44 1.83a.75.75 0 00.9 0l3.3-2.5c.44-.33 1.01.17.72.64z"/>
          </svg>
        )}
      </motion.button>
