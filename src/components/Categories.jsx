  ...
  return (
    <section className="py-8 min-[480px]:py-10 min-[768px]:py-16 overflow-hidden">
      ...
      <div ref={containerRef} className="overflow-hidden px-3 min-[480px]:px-6 py-2 min-[480px]:py-4">
        <motion.div
          className="flex gap-5 min-[480px]:gap-7 min-[768px]:gap-10 cursor-grab active:cursor-grabbing select-none w-max"
          drag="x"
        ...
        >
          {categories.map((cat) => (
            <Link
              ...
              className="flex flex-col items-center gap-2 min-[480px]:gap-3 min-[768px]:gap-4 flex-shrink-0"
            >
              <div className="w-16 h-16 min-[480px]:w-20 min-[480px]:h-20 min-[768px]:w-24 min-[768px]:h-24 md:w-28 md:h-28 rounded-full bg-white shadow-md border border-gray-100 overflow-hidden hover:shadow-lg hover:-translate-y-1 hover:scale-110 transition-all duration-300">
                <Image
                  src={cat.image}
                  alt={cat.name}
                  width={112}
